...
def graph(list1,list2):
    ...
    ylabel2.draw(win)
    xlabel1 = Text(Point(237.5,510), 2)
    xlabel1.draw(win)
    xlabel2 = Text(Point(475,510), 4)
    xlabel2.draw(win)
    xlabel3 = Text(Point(712.5,510), 6)
    xlabel3.draw(win)
    xlabel4 = Text(Point(900,510), 8)
    xlabel4.draw(win)
...
yvals=start(-math.pi/2)
yvals2=start(math.pi/2)
graph(yvals, yvals2)
